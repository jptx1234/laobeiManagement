...
<div class="well center-block" style="width: 600px;">
	...
	<div class="mainContent" id="content" style="background-color: #fff;">
		<table id="content-table" class="table table-bordered">
			<tbody>
			<tr class="propName" style="font-weight: bold;"><td colspan="2">采购列表 ${date }</td></tr>
			...
			<tr class="role"><td colspan="2">图片</td></tr>
			<c:forEach items="${imgFiles }" var="imgFile">
				<tr class="content">
					<td colspan="2">
						<img alt="${imgFile }" src="${ctx }/upload/${imgPath}/${imgFile}" width="500px">
					</td>
				</tr>
			</c:forEach>
			</tbody>
